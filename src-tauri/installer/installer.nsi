...
Function FindNonSystemDrive
  ; Pick the first mounted fixed drive after C: for a new installation.
  StrCpy $0 "DEFGHIJKLMNOPQRSTUVWXYZ"
  drive_loop:
    StrCpy $1 $0 1
    StrCpy $0 $0 "" 1
    StrCmp $1 "" drive_fallback
    System::Call 'kernel32::GetDriveType(t "$1:\") i .r2'
    ${If} $2 = 3
      StrCpy $INSTDIR "$1:\${PRODUCTNAME}"
      Return
    ${EndIf}
    Goto drive_loop
  drive_fallback:
